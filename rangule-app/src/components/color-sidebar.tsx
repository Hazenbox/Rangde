...
function PaletteItem({
  ...
  return (
    <div
      className={cn(
        "group flex h-8 items-center justify-between rounded-lg px-2 text-xs transition-colors cursor-pointer",
        isActive
        ...
        >
          <div className="flex flex-col">
            ...
            >
              ...
              {downloadHover && (
                <div 
                  className="absolute left-full top-0 ml-1 w-28 rounded-md border bg-popover p-1 shadow-md"
                  onMouseEnter={() => setDownloadHover(true)}
                  onMouseLeave={() => setDownloadHover(false)}
                >
                  <button
            ...
            {/* Delete */}
            <button
              className="rounded px-2 py-1.5 text-xs hover:bg-destructive hover:text-destructive-foreground text-left text-destructive cursor-pointer"
              onClick={(e) => {
                e.stopPropagation();
                setMenuOpen(false);
                onDelete();
...
export function ColorSidebar() {
  ...
  return (
    <div className="flex h-full w-56 flex-col bg-sidebar-background">
      <div className="flex items-center justify-between p-3">
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <DialogTrigger asChild>
            <Button variant="secondary" size="icon" className="h-7 w-7 rounded-full cursor-pointer">
